...
#ifndef MRH_ABException_h
#define MRH_ABException_h
...
public:
    ...
    MRH_ABException(std::string s_Message) : s_Message(s_Message)
    {}
    ...
    MRH_ABException(const char* p_Message) : s_Message(p_Message != NULL ? p_Message : "")
    {}
